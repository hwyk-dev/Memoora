...
<div x-data="{ sidebarOpen: false }" class="flex min-h-screen">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex items-center gap-3 px-5 h-16 border-b border-slate-200 dark:border-zinc-800 flex-shrink-0">
            ...
            <span class="text-base font-semibold text-slate-900 dark:text-slate-100 select-none">Memoora</span>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            ...
            @if (auth()->user()->is_admin)
                <div class="pt-3 mt-2 border-t border-slate-100 dark:border-zinc-800">
                    <p class="px-3 mb-1 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">{{ __('messages.nav.admin') }}</p>
